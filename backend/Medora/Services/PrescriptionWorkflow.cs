...
{
	public static bool CanCreateFromAppointment(AppointmentStatus status, bool hasExistingPrescription)
	{
	...
	public static bool IsAppointmentOwnedByDoctor(Appointment appointment, int doctorId)
	{
